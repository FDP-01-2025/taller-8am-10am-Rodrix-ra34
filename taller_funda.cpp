...
void eliminarEstudiante() {
    ...
    cout << "Por favor, ingrese el carnet del estudiante que desea eliminar: ";
    cin >> buscado;
    ...
    if (archivo.is_open() && temp.is_open()) {
        ...
        if (eliminado)
            cout << "Se ha podido eliminar al estudiante exitosamente, felicidades.\n";
        else
            cout << "Disculpe, pero no ha sido posible encontrar el carnet\n";

    } else {
        cout << "Ha habido un error al abrir los archivos, intentelo de nuevo.\n";
     }
}
// -----------------------------
